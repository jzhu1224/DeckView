...
import com.brighttech.deckview.helpers.FakeShadowDrawable;
...
public class DeckChildView<T> extends FrameLayout implements
    ...
    private void initView() {
        ...
        if (mConfig.fakeShadows) {
            setBackground(new FakeShadowDrawable(getResources(), mConfig));
        }
    }
    ...
    public void setDim(int dim) {
        ...
        if (mConfig.useHardwareLayers) {
            ...
            if (getMeasuredWidth() > 0 && getMeasuredHeight() > 0) {
                ...
                getContent().setLayerType(LAYER_TYPE_HARDWARE, mDimLayerPaint);
            }
        } else {
            //TODO:
