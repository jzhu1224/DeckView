...
import com.brighttech.deckview.helpers.DeckChildViewTransform;
...
import com.brighttech.deckview.utilities.DozeTrigger;
import com.brighttech.deckview.utilities.ReferenceCountedTrigger;
...
public class DeckView<T> extends FrameLayout implements /*TaskStack.TaskStackCallbacks,*/
    ...
    private static final String TAG = DeckView.class.getSimpleName();
    ...
    public DeckChildView createView(Context context) {
        ...
        deckChildView.setContent(mCallback.getView(getContext()));
    ...
    public interface Callback<T> {
        ...
        void loadViewData(WeakReference<DeckChildView<T>> dcv, T item);
